          ...
          <div className="text-center py-8 sm:py-12" suppressHydrationWarning>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4">
              {[
                ...
                <div
                  key={index}
                  className="p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow"
                >
        ...
        {currentStep !== 'welcome' && (
          <div className="mb-6 sm:mb-8" suppressHydrationWarning>
            <div className="flex items-center justify-between mb-2 text-xs sm:text-sm">
              ...
              <span className="font-medium text-gray-700 dark:text-gray-300">
                {dict.onboardingPage.step}{' '}
                {steps.findIndex((step) => step.id === currentStep) + 1}{' '}
                {dict.onboardingPage.of} {steps.length}
              </span>
            </div>
