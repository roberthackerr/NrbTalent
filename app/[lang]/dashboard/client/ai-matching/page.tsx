// app/dashboard/clients/ai-matching/page.tsx
"use client"
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-indigo-100">
                      <CardContent className="pt-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-blue-900 text-sm">AI Avancée</h4>
                            <p className="text-xs text-blue-700">Algorithmes optimisés</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-100">
                      <CardContent className="pt-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-green-900 text-sm">Profils Vérifiés</h4>
                            <p className="text-xs text-green-700">Freelancers validés</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-violet-100">
                      <CardContent className="pt-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-purple-900 text-sm">95% Satisfaction</h4>
                            <p className="text-xs text-purple-700">Clients satisfaits</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
