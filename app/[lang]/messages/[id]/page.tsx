...
export default function ConversationPage() {
  ...
  const handleStartVideoCall = useCallback(() => {
    ...
    }, 45000) // 45 secondes pour répondre
...
case 'PONG':
  ...
  }, [conversationManager, scrollToBottom, typingManager, videoCallChannel, handleEndCall, isVideoCallOpen, showOutgoingCall, showIncomingCall])
