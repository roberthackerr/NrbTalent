// components/ConversationsSidebar.tsx - VERSION PROFESSIONNELLE
...
export const ConversationsSidebar = ({
  ...
  // 🔥 FORMATER LE DERNIER MESSAGE - Version Pro
  const formatLastMessage = (message: string | undefined | null, isAIConversation: boolean, senderId?: string): string => {
    ...
    // Préfixe "Vous: " si c'est nous qui avons envoyé
  ...
  // 🔥 FORMATER LA DATE - Version Pro avec "il y a"
  ...
  // 🔥 MEMOIZE: Conversations triées et filtrées (évite les recalculs)
    ...
    <div className="w-80 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 space-y-3">
        ...
        <Button
          ...
          disabled={!isConnected}
          className="w-full h-9 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white text-sm font-medium shadow-sm disabled:opacity-40"
        >
